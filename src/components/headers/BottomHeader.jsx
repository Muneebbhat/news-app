        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 hel-el">
                          ...
                          <div className="row">
                            <div className="col-lg-3 herald-mega-menu-sub-cats">
                              <ul>
                                <li>
                                  <a
                                    href="https://demo.mekshq.com/herald/?cat=48"
                                    >Celebrities</a
                                  >
                                </li>
                                <li>
                                  <a
                                    href="https://demo.mekshq.com/herald/?cat=43"
                                    >Movies</a
                                  >
                                </li>
                                <li>
                                  <a
                                    href="https://demo.mekshq.com/herald/?cat=42"
                                    >Music</a
                                  >
                                </li>
                              </ul>
                                ...
                                >
                                  ...
                                  <div className="entry-header">
                                    ...
                                    <h2 className="entry-title h6">
                                      <a
                                        href="https://demo.mekshq.com/herald/?p=171"
                                        >Start recording like a pro with the
                                        help of these 6 tips</a
                                      >
                                    </h2>
                                ...
                                >
                                  ...
                                  <div className="entry-header">
                                    ...
                                    <h2 className="entry-title h6">
                                      <a
                                        href="https://demo.mekshq.com/herald/?p=167"
                                        >The 10 interesting benefits of
                                        listening to classNameical music</a
                                      >
                                    </h2>
                                    <div className="entry-meta meta-small">
                                      <div className="meta-item herald-date">
                ...
                <div className="herald-menu-popup-search">
                  ...
                  <div className="herald-in-popup">
                    ...
                    >
                      ...
                      /><button
                        type="submit"
                        className="herald-search-submit"
                      ></button>
                    </form>
                  </div>
                </div>
              ...
              <div className="hel-r">
                <ul id="menu-herald-social" className="herald-soc-nav">
                  <li
                    id="menu-item-1037"
                    className="
                      menu-item
