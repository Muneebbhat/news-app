          ...
          <div style={{backgroundColor:'red'}}
              ...
              >
                ...
                <div className="row herald-posts row-eq-height">
                  ...
                  >
                    <div
                      className="herald-post-thumbnail herald-format-icon-middle"
                    >
                      <a
                    ...
                    <div className="entry-header">
                      ...
                      <h2 className="entry-title h3">
                        <a href="https://demo.mekshq.com/herald/?p=191"
                          >Pasta is the secret ingredient for a healthy
                          lifestyle</a
                        >
                      </h2>
                        ...
                        <div className="meta-item herald-author">
                          <div className="coauthors couauthors-icon">
                            <span className="vcard author"
                              ><span className="fn"
                                ><a
                                  href="https://demo.mekshq.com/herald?author_name=meks1"
                                  >Patrick Callahan</a
                                ></span
                              ></span
                            ><span className="vcard author"
                              ><span className="fn"
                                ><a
                                  href="https://demo.mekshq.com/herald?author_name=meks2"
                                  >Lisa Scholfield</a
                                ></span
                              ></span
                            >
                    ...
                    <div className="entry-content">
                      <p>
                        This is an example of a post with multiple authors to
                        showcase full support with Co Authors Plus WordPress
                        Plugin. Master cleanse mumblecore...
                      </p>
                    </div>
                  </article>
